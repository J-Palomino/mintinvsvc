...
class OdooSyncService {
  ...
  async syncProduct(item, warehouseId) {
    ...
    const variantVals = {
      ...
      x_price_rec: item.price_rec,
      x_price_med: item.price_med,
      x_special_price: item.special_price,
      x_special_price_rec: item.special_price_rec,
      x_special_price_med: item.special_price_med,
      x_unit_cost: item.unit_cost,
      x_thc_percentage: item.thc_percentage,
      x_thc_percentage_min: item.thc_percentage_min,
      x_thc_percentage_max: item.thc_percentage_max,
      x_cbd_percentage: item.cbd_percentage,
      x_cbd_percentage_min: item.cbd_percentage_min,
      x_cbd_percentage_max: item.cbd_percentage_max,
      x_thc_mg: item.thc_mg,
      x_cbd_mg: item.cbd_mg,
      ...
      x_net_weight_grams: item.net_weight_grams,
      x_weight_unit: item.weight_unit,
      x_size: item.size,
      ...
      x_quantity_on_floor: item.quantity_on_floor,
      x_synced_at: new Date().toISOString(),
    };
